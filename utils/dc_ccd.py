...
def _run_ccd_on_pixel(ds):
    ...
    cloud_mask = utils.create_bit_mask(ds.pixel_qa, [1, 2]) & utils.create_bit_mask(ds.pixel_qa, [1, 2])
    ...
    return ccd.detect(date, blue, green, red, nir, swir1, swir2, thermals, qa,params = params)
